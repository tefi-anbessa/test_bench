...
Pagy::DEFAULT[:overflow] = :empty_page    # default  (other options: :last_page and :exception)require 'pagy/extras/overflow'
# ::DEFAULT[:overflow] = :last_page   # default  (other options: :last_page and :exception)
