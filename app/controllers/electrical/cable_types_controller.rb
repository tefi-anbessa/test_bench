module Electrical
  class CableTypesController < ApplicationController
    ...
    def index
      @q = policy_scope(@discipline.electrical_cable_types).ransack(params[:q])
    ...
    def new
      @cable_type =  @discipline.electrical_cable_types.new()
      authorize @cable_type
      setup_form
    end
    ...
    private
      ...
      def cable_type_params
        params.require(:electrical_cable_type).permit(
          ...
          :temperature_rating, :voltage_rating, :discipline_id, :notes
        )
      end
  end
end