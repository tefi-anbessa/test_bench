class SwitchboardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @switchboard.save
        format.html { redirect_to @switchboard, notice: "Switchboard was successfully created." }
  ...
  def update
    respond_to do |format|
      if @switchboard.update(switchboard_params)
        format.html { redirect_to @switchboard, notice: "Switchboard was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to switchboards_path, status: :see_other, notice: "Switchboard was successfully destroyed." }
  ...
  private
    ...
    def switchboard_params
      params.require(:switchboard).permit(:location, :service, :ingress_protection, :busbar_rating, :busbar_fault_rating, :busbar_fault_duration, :cable_entry, :incomer_protection, :incomer_metering, :neutral_bar_connections, :earth_bar_connections)
    end
end
