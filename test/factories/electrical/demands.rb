FactoryBot.define do
  factory :electrical_demand, class: 'Electrical::Demand' do
    # Electrical Demandable must be provided
    # Default to light_cct for backward compatibility
    demandable { create(:electrical_light_cct) }
